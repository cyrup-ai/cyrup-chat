...
#[allow(dead_code)] // Any timeline provider - architectural scaffolding pending integration
...
impl AnyTimelineProvider {
    #[allow(dead_code)] // Any timeline provider constructor - pending integration
    pub fn new<T: Hash>(
